...
function modeswitch(){
    if(mode == "dark"){
        ...
        document.getElementById("scrollscroll").style.backgroundColor = "#F8F0E3";
        document.getElementById("scrollscroll").style.color = "black";

        document.getElementById("scrollinput").style.color = "black";
        document.getElementById("scrollinput").style.backgroundColor = "#F8F0E3";       
        document.getElementById("scrollsbox").style.backgroundColor = "#F8F0E3";
